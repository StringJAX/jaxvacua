...
try:
    import cytools
    #print("NEED TO IMPORT NEW SCRIPT!")
except ImportError:
...
class flux_sector_private(flux_sector):
    ...
    def __init__(
        ...
        **Description:**
        ...
        super(flux_sector_private, self).__init__(h12,Q=Q,model_ID = model_ID,model_type =model_type,moduli_space_limit = moduli_space_limit,
    ...
    def __repr__(self) -> str:
        ...
        **Description:**
        ...
        if self.periods.name!="":
            return f"Private flux sector for {self.periods.name} with h12={self.h12} complex structure moduli in the {self.periods.moduli_space_limit} limit."
        else:
            return f"Private flux sector for h12={self.h12} complex structure moduli in the {self.periods.moduli_space_limit} limit."
    ...
    def _split_fluxes(
        ...
        **Description:**
        ...
        Args:
            fluxes (ArrayLike): Flux vector.
        
        Returns:
            ArrayLike: Flux vector :math:`f_1`.
            ArrayLike: Flux vector :math:`f_2`.
            ArrayLike: Flux vector :math:`h_1`.
            ArrayLike: Flux vector :math:`h_2`.
        
        """

        f = fluxes[:self.n_fluxes]
        h = fluxes[self.n_fluxes:]
        f1 = f[:self.dimension_H3]
        f2 = f[self.dimension_H3:]
        h1 = h[:self.dimension_H3]
        h2 = h[self.dimension_H3:]
    ...
    def flux_to_pfv(
        ...
        **Description:**
        ...
        Args:
            flux (ArrayLike): Flux-vector.           
        
        Returns:
            M (ArrayLike): M-vector.
            K (ArrayLike): K-vector.  
    ...
    def pfv_to_moduli(
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Values of complex structure moduli.
    ...
    def W1_tilde(self,zbulk,tau,f2,h2,P1,K1,conj=False):
        ...
        **Description:**
        ...
        Args:
            zbulk (ArrayLike): Values of the complex structure moduli excluding the conifold modulus.
            tau (complex): Value of the axio-dilaton :math:`\tau`.
            f2 (ArrayLike): Flux vector :math:`f_2`.
            h2 (ArrayLike): Flux vector :math:`h_2`.
    ...
    def zcf_handling(self,x,flux,mode=None):
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Real variables including the conifold modulus.
    ...
    def DW_x_bulk(self,x,flux,mode=None):
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Gradient of the flux superpotential with respect to the bulk moduli.
        """
    ...
    def dDW_x_bulk(self,x,flux,mode=None):
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Hessian of the flux superpotential with respect to the bulk moduli.
    ...
    def codim_vacuum_moduli_space(self, moduli, moduli_c, tau, tau_c, fluxes,mode="SUSY",tolerance=1e-10):
        ...
        **Description:**
        ...
        Returns:
            (ArrayLike): Number of massive directions.
    ...
    @partial(jit, static_argnums = (0,))
    def scalar_potential_mod(self,moduli,moduli_c,tau,tau_c,fluxes):
        r"""
    ...
    def _hessian_real(
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Value of :math:`\partial_{\phi^\alpha}\partial_{\phi^\beta}V`.
    ...
    def linearised_shifts_ISD(self,moduli,tau,fluxes,mode="ISD",return_shifts=False,remove_NANs = False):
        """
        **Description:**
        ...
        Returns:
            ArrayLike: Moduli shifts or shifted values of the complex structure moduli :math:`Z^i`.
            complex: Axio-dilaton shift or shifted value of the axio-dilaton :math:`\tau`.
            ArrayLike: Values of the fluxes.
        """
    ...
    @partial(jit, static_argnums = (0,4,5,6,))
    def linearised_shifts_H(self,moduli,tau,fluxes,mode="Hflux",return_shifts=False,remove_NANs=False):
        """
        **Description:**
        Computes linearised shifts for the complex structure moduli and axio-dilaton based on given H-flux.

        Args:
            moduli (ArrayLike): Starting point for the complex structure moduli.
    ...
    @partial(jit, static_argnums = (0,4,5,6,))
    def linearised_shifts_F(self,moduli,tau,fluxes,mode="Fflux",return_shifts=False,remove_NANs=False):
        """
        **Description:**
        ...
        #raise NotImplementedError("Map for F-fluxes note yet imlemented!")

        modes = ["Fflux","Fflux_random"]
    ...
    def linearised_shifts(self,moduli,tau,fluxes,Q=None,mode="ISD",return_flag=True,constraints = None,remove_NANs=False):
        r"""
        ...
        **Description:**
        ...
        Returns:
            ArrayLike: Shifted values for the complex structure moduli :math:`Z^i`.
            complex: Shifted value for the axio-dilaton :math:`\tau`.
            ArrayLike: Updated values for the fluxes based on the ISD-condition.
    ...
    def compute_residual(self,x,axis=1):
        ...
        **Description:**
        ...
        Returns: 
            ArrayLike: Sum of absolute values.
    ...
    def fterm_solver(
        ...
        **Description:**
        ...
        Returns: 
            ...
            ArrayLike: Array of fluxes. The ordering starts with RR-fluxes, then the NSNS-fluxes.
            ArrayLike: Boolean array specifying whether constraints are satisfied.
            ArrayLike: Residuals :math:`\sum_A |D_A W|` of the :math:`F`-terms.
    ...
    def sample_SUSY_flux_vacua(
                               ...
                               max_tadpole: int = None,
                               objective_fct: Callable = None, 
                               optimiser: Callable = None, 
                               optimisers: list = None, 
    ...
    def sample_SUSY_vacua_from_fluxes(
                                      ...
                                      max_tadpole = None,
                                      objective_fct = None,
                                      optimiser_init: callable = None,
                                      optimiser_steps: callable = None,
                                      constraints=None,
                                      mode=None,
                                      tol = 1e-10,
                                      vmap_dim_flux = 10,
